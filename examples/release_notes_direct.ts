/**
 * release_notes_direct: the same agent as release_notes.ts, written in the
 * direct style.
 *
 * Where release_notes.ts declares its topology as a `chain`, this version is
 ...
 *
 * Run directly:
 *   pnpm exec tsx examples/release_notes_direct.ts
 */
